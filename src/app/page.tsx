...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/young-attractive-woman-walking-street_1303-23416.jpg",
          alt: "Client 4",
        },
        {
          src: "http://img.b2bpic.net/free-photo/conceptual-3d-render-credit-debit-cards-futuristic-platform_187299-47941.jpg",
          alt: "Client 5",
        },
      ]}
      buttons={[
        {
          text: "Discover Premium Banking",
          href: "#contact",
        },
      ]}
      marqueeItems={[
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/cheerful-boss-sitting-with-newspaper-table_1098-3037.jpg",
          alt: "Client 3",
        },
        {
      ...
      metrics={[
        {
          ...
          description: "Consistently delivered through dedicated white-glove service.",
          imageSrc: "http://img.b2bpic.net/free-photo/business-meeting-cafe_53876-94719.jpg",
        },
        {
          id: "m2",
          value: "$5B+",
          title: "Wealth Under Management",
          description: "Ensuring stability and long-term prosperity for our clientele.",
          imageSrc: "http://img.b2bpic.net/free-photo/cheerful-project-manager-showing-presentation-laptop-colleague-office-medium-shot-front-view-teamwork-communication-concept_74855-11609.jpg",
        },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "faq1",
          title: "How do I become a premium banking client?",
          content: "You can request a consultation via our website, and a Relationship Manager will reach out to facilitate the process.",
        },
        {
          id: "faq2",
          title: "Is my wealth portfolio diversified globally?",
          content: "Yes, we offer specialized multi-currency accounts and global investment avenues suited for your strategic goals.",
        },
        {
          id: "faq3",
          title: "Do you provide dedicated account support?",
          content: "Every premium account holder is paired with a personal Relationship Manager for round-the-clock priority assistance.",
        },
      ]}
